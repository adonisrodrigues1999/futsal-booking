...
urlpatterns = [
    ...
    path('login/verify-otp/', views.verify_customer_otp, name='verify_customer_otp'),
    ...
    path('ground/<int:ground_id>/price-drop-toggle/', views.toggle_ground_price_drop, name='toggle_ground_price_drop'),
