...
WHATSAPP_OTP_TEMPLATE_NAME = env_text('WHATSAPP_OTP_TEMPLATE_NAME', '')
WHATSAPP_OTP_TEMPLATE_LANGUAGE = env_text('WHATSAPP_OTP_TEMPLATE_LANGUAGE', 'en')
WHATSAPP_WEBHOOK_VERIFY_TOKEN = env_text('WHATSAPP_WEBHOOK_VERIFY_TOKEN', '')
WHATSAPP_APP_SECRET = env_text('WHATSAPP_APP_SECRET', '')
CUSTOMER_WHATSAPP_OTP_ENABLED = env_bool('CUSTOMER_WHATSAPP_OTP_ENABLED', default=False)
CUSTOMER_OTP_EXPIRY_MINUTES = int(os.getenv('CUSTOMER_OTP_EXPIRY_MINUTES', '10'))
CUSTOMER_OTP_MAX_ATTEMPTS = int(os.getenv('CUSTOMER_OTP_MAX_ATTEMPTS', '5'))
